...
from src.core.utils import init_logger, load_tokenizer, set_seed, MODEL_CLASSES, MODEL_PATH_MAP
from src.core.data_loader import load_and_cache_examples
...
if __name__ == '__main__':
    ...
    parser.add_argument('--slot_loss_coef',
                        type=float,
                        default=1.0,
    ...
    parser.add_argument("--slot_pad_label",
                        default="PAD",
                        type=str,
